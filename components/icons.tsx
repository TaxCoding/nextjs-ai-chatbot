  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M34.7 0H13.3C5.95 0 0 5.95 0 13.3v21.4C0 42.05 5.95 48 13.3 48h21.4C42.05 48 48 42.05 48 34.7V13.3C48 5.95 42.05 0 34.7 0zM24 16.45c4.15 0 7.55 3.4 7.55 7.55s-3.4 7.55-7.55 7.55-7.55-3.4-7.55-7.55 3.4-7.55 7.55-7.55zm8.8-3.65c1.1 0 2.05.9 2.05 2.05s-.9 2.05-2.05 2.05-2.05-.9-2.05-2.05.95-2.05 2.05-2.05zm-8.8 2.7c-3.25 0-5.9 2.65-5.9 5.9s2.65 5.9 5.9 5.9 5.9-2.65 5.9-5.9-2.65-5.9-5.9-5.9zm0 9.7c-2.1 0-3.8-1.7-3.8-3.8s1.7-3.8 3.8-3.8 3.8 1.7 3.8 3.8-1.7 3.8-3.8 3.8z"
        fill="currentColor"
      />
    </svg>
  );
